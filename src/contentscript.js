    ...
    window.com_sogou_abp = {
        ...
        addElementOverlay: function(elt) {
            ...
            if (typeof(getComputedStyle) != 'undefined')
                ...
                var thisStyle = {width: elt.offsetWidth, height: elt.offsetHeight};
        ...
        addRules : function (filters){
            sogouExplorer.extension.sendRequest({cmd: "addRules", filters: filters});
        },
            ...
            switch (request.cmd) {
                case "isClipping":
                    if (window.top == window) //顶层窗口才发
                        port.postMessage({cmd: "isClipping", result: com_sogou_abp.clickHide_activated});
                    break;
                case "startClipping":
